...
public static RemoteObject _tcpsocket = RemoteObject.declareNull("xsocket.client.xClientSocket");
  public Object[] GetGlobals() {
		return new Object[] {"Button1",main._button1,"fx",main._fx,"MainForm",main._mainform,"tcpSocket",main._tcpsocket,"xui",main._xui};
}
}